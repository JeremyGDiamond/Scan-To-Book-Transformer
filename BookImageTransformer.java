...
public class BookImageTransformer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.print("Enter Image Directory\n");
        dir = reader.readLine();
        
        images = filesList(dir);
        System.out.println(images.get(0));
        
        while (!("1".equals(choise) || "2".equals(choise))){
                System.out.print("enter 1 for singal transform and 2 for staggerd transform\n");
        ...
        while (!("y".equals(choise) || "n".equals(choise))){
                System.out.print("enter y to copy all files and n to not\n");
                choise = reader.readLine();
